...
public class StudentController {
	...
	//@Autowired
	// to get a link from @Component in StudentServiceImpl
	// better to do it in interface
	...
	public boolean studentRegister(@RequestBody StudentsCredentialsDto studentsCredentialsDto) {
		return studentService.add(studentsCredentialsDto);
	}
	...
	public StudentsCredentialsDto editStudent(@PathVariable Integer id,
